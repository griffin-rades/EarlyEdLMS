...
<div class="card bg-light text-center mx-auto">
	<div class="card-body">
		...
		<p class="lead">Early Education LMS is a software designed to give teacher of elementry grade students the ability to track and record infromation on their students.</p>
		<?php if(is_loggedin()): ?>
